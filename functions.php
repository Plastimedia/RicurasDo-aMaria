    ...
    <div class="form-field term-group">
        ...
        <p>
            <input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button"
                name="ct_tax_media_button" value="Añadir imagen" />
            <input type="button" class="button button-secondary ct_tax_media_remove" id="ct_tax_media_remove"
                name="ct_tax_media_remove" value="Eliminar imágen" />
        </p>
    </div>
    <?php
}
        ...
        <td>
            ...
            <p>
                <input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button"
                    name="ct_tax_media_button" value="Añadir imagen" />
                <input type="button" class="button button-secondary ct_tax_media_remove" id="ct_tax_media_remove"
                    name="ct_tax_media_remove" value="Eliminar imagen" />
            </p>
        </td>
    </tr>
    <?php
...
// catidad de productos a mostrar
                                    ...
                                    if ($product->get_id() != $product_id_actual) {
                                        ...
                                        <li <?php wc_product_class('splide__slide', $product); ?>>
                                            <div class="producto">
                                                <div class="content">
                                                    ...
                                                    if (wp_get_attachment_url(get_post_meta($product->get_id(), '_imagen_secundaria_id', true)) != '') {
                                                        ...
                                                        <a href="<?php echo get_the_permalink(); ?>">
                                                            <img src="<?php echo wp_get_attachment_url(get_post_meta($product->get_id(), '_imagen_secundaria_id', true)); ?>"
                                                                class="secundaria" alt="">
                                                        </a>
                                                        <?php
                                                    }
                                                    ?>
                                                ...
                                                <h3><a href="<?php echo the_permalink(); ?>"><?php echo $product->get_name() ?></a>
                                                </h3>
